...
Link to the PDF version of my [CV](cv.pdf) 
...
#### Electrostatics of Spherical Topological Insulators     
...
#### Analysis of data from CERN 2010 open data and simulation of top pair production
...
- **52nd Saas-Fee winter School on "The Circum-Galactic Medium across cosmic time: an observational and modelling challenge"** (March 19-24, 2023)
Presented a poster about my work. In-person at Les Diablerets, Switzerland

- **Team meeting for "Observe Local Think Global: What Solar Observations can teach us about Multiphase Plasmas across Astrophysical Scales"** (March 13-17, 2023)
...
Was involved in organising the 13th IMPRS Symposium as the Chair of the Local Organising Committee. 
...
Constructed and demonstrated an experiment about Bernard cells, convection and convection cells in Sun. Also, demonstrated an experiment about Polarization of light.
...
**Hydrodynamic Simulation**: Athena++ , PLUTO   
**Interpreted languages**: Python   , Matlab, Mathematica    
**Others**: LaTeX, ROOT, Bash scripting, High Performance Computing     
:::
